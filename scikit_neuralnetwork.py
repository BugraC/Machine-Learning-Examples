...
class neural_network:
    ...
    def train(self):
        ...
        parameters = {'learning_rate': [0.05, 0.01, 0.005, 0.001],
        'hidden0__units': [4, 8, 12, 24],
    ...
    def report(self):
        if (self.isRegression):
            ...
            self.clf = MLPClassifier(solver='lbfgs', alpha=1e-5, hidden_layer_sizes=(self.hiddenLayerSizes,),
                                     random_state=1)
